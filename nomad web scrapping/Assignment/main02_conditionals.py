...
def add_to_dict(dic, word, meaning=None):
  if type(dic) == dict:
    if word not in dic:
      if meaning is None:
...
def get_from_dict(dic, word=None, meaning=None):
  if type(dic) != dict:
    print("you need to send a dictionary. you sent:", type(dic))
  else:
    if word is None:
...
def update_word(dic, word=None, meaning=None):
  if type(dic) != dict:
    print("You need to send a dictionary. You sent:", type(dic))
  else:
    if word != None:
      ...
      elif word in dic and meaning != None:
        #수정하시오
        dic[word]=meaning
        print(f"{word} has been updated to: {meaning}")
